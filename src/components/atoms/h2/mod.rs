...
pub fn H2(props: &Props) -> Html {
    match props.color {
        HeaderColor::Primary => {
            html! {
                <div class={format!("p-6 text-3xl text-primary-light dark:text-primary-dark {}",props.class)}>
        ...
        HeaderColor::Secondary => {
            html! {
                <div class={format!("p-6 text-3xl text-secondary-light dark:text-secondary-dark {}",props.class)}>
                    {for props.children.iter()}
                </div>
            }
        }
        HeaderColor::Tertiary => {
            html! {
                <div class={format!("p-6 text-3xl text-tertiary-light dark:text-tertiary-dark {}",props.class)}>
                    {for props.children.iter()}
                </div>
            }
        }
        HeaderColor::OnPrimary => {
            html! {
                <div class={format!("p-3 text-3xl text-primary-on-light dark:text-primary-on-dark {}",props.class)}>
                    {for props.children.iter()}
                </div>
            }
        }
